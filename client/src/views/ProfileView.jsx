            ...
            <FadeAnimation>
                ...
                <FadeAnimation>
                    <div className="h-full flex flex-col justify-center items-center gap-7 mt-9">
                        ...
                        <button onClick={editButton} className="w-80 h-12 mb-10 mt-5 rounded-4xl uppercase font-bold tracking-wider text-white bg-[var(--orange-accent)] cursor-pointer transition-all duration-300 ease-in-out shadow-black/10 hover:shadow-amber-600/40 shadow-xl">
                            Confirmar
                        </button>
                    </div>
                </FadeAnimation>
